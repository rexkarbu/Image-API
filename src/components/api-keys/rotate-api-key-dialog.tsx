...
import { ApiKeyDto, RotateApiKeyResult } from "@/lib/services/api-keys";
    ...
    >
      <div className="w-full max-w-md rounded-xl border border-neutral-200 dark:border-neutral-800 bg-white dark:bg-neutral-900 p-6 shadow-2xl space-y-5 animate-in fade-in zoom-in-95">
        ...
        <div className="space-y-3">
          ...
          <div
            onClick={() => setMode("grace_24h")}
            className={`cursor-pointer rounded-lg border p-3 text-xs transition-colors space-y-1 ${
              mode === "grace_24h"
